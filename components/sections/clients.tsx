...
export default function Clients() {
  const clients = [
    ...
    { image: "/ThinkRealEstate-Logos-3 (1).png", title: "Think Real Estate" },
    { image: "/WARRENgroupLogoFINAL.png", title: "WARREN Group" },
  ...
  return (
    <section className="border-t">
      ...
      <div className="container border-none p-0!">
        <div className="grid grid-cols-2 md:grid-cols-4 border-t border-l">
          {clients.map((logo, i) => (
            <div
              ...
              key={i}
            >
              <div className="absolute inset-x-0 bottom-0 h-full bg-primary/5 translate-y-full transition-all duration-200 group-hover:translate-y-0" />
